...
namespace AmusemenMiniGame
{
    public class Fruit : MonoBehaviour
    {
        ...
        [SerializeField] private GameObject plus10AmusementPrefab;
        ...
        private void GainAmusemen()
        {
            statsController.ChangeStats(StatsController.Stats.Amusement, 10);
            var points = Instantiate(plus10AmusementPrefab, transform.position, Quaternion.identity);
            Destroy(points, 3f);
        }
    }
}